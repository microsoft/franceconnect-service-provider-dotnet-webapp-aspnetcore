...
- [Chemin de migration raccourci d'un ancien fournisseur de service sous ASP.NET Core 1 Preview 2 vers ASP.NET Core 3.1](./Migration-ASPNETCore-1PreviewVers3.1.md)
- [Ancien guide d'implémentation d'un fournisseur de Service sous ASP.NET Core 1 - 2016](./Archives/Mettre%20en%20oeuvre%20un%20FS%20FranceConnect%20avec%20ASP.NET%20Core%201.0.docx)
